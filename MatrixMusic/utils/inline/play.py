...
def stream_markup_timer(_, chat_id, played, dur):
    ...
    buttons = [
        ...
        [InlineKeyboardButton("⏤͟͞ َِ➧꯭𝐘꯭𝐀꯭𝐙꯭𝐀꯭𝐀꯭𝐍꯭ᯓ꯭ ➧꯭ʟ̤ɾ꯭ʅɠ꯭ᓆ꯭⅃꯭Ȋ𓆪", url=f"https://t.me/CZCRR")],
...
def stream_markup(_, chat_id):
    buttons = [
        ...
        [InlineKeyboardButton(text="ᏟᎻᎪΝΝᎬᏞ", url=f"https://t.me/ccvzu"), InlineKeyboardButton(text="ᏟᎻᎪΝΝᎬᏞ²", url=f"https://t.me/ccvzu")],
        [InlineKeyboardButton("➧꯭𝐘꯭𝐀꯭𝐙꯭𝐀꯭𝐀꯭𝐍꯭ᯓ꯭ ➧꯭ʟ̤ɾ꯭ʅɠ꯭ᓆ꯭⅃꯭Ȋ", url=f"https://t.me/CZCRR")],
        [InlineKeyboardButton(text="اضف البوت الي مجموعتك او قناتك ⚡️", url=f"https://t.me/F6Z_bot?startgroup=True")],
    ]
    return buttons
